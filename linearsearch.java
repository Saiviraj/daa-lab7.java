...
int inputArray[] = new int[inputArraySize]; System.out.println("Enter " +inputArraySize+" Array Elements:"); for (int i = 0; i < inputArray.length; i++) {
...
int seachKeyIndex = linearSearch(inputArray,startIndex,lastIndex,seachKey); if( seachKeyIndex != -1)
...
if(inputArray[startIndex] == seachKey) return startIndex;
